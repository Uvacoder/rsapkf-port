...
[VSCode Neovim](https://marketplace.visualstudio.com/items?itemName=asvetliakov.vscode-neovim) ([Source](https://github.com/asvetliakov/vscode-neovim)) is a more advanced plugin that provides a full embedded Neovim integration with custom `init.vim` and Vim plugins by using Neovim as the backend.
