  ...
  return (
    <Layout>
      ...
      <p style={{marginTop: '1rem'}}>
        Hey, I'm <Link to="/about">Rey</Link>, a software developer, autodidact,
        ...
        <a href="https://jamstack.org/">Jamstack</a>, and{' '}
        <Link to="/technologies">other cool technologies</Link>.
        <br />
        <br />
        ...
        <br />
        See what I'm upto <Link to="/now">right now</Link>.
        <br />
      </p>
      <hr />
      <p>
