...
| F    | ![F](https://raw.githubusercontent.com/rsapkf/rupiks/main/pll/svg/F.svg)   | <ul><li>Full bar, No connected bar, Opposite colors pair next to bar</li></ul>                                                                  | <ul><li>(R' U' F') (R U R' U') (R' F R2 U') (R' U' R U) (R' U R)</li></ul>                                                                                 |                                                                                                                                                                                                                       |
