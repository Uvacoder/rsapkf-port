...
This site is powered by [Gatsby](https://github.com/gatsbyjs/gatsby), an open source static site generator built on top of [React](https://github.com/facebook/react) and [GraphQL](https://github.com/graphql/graphql-spec), two of the most popular modern web technologies. It is hosted on [Netlify](https://www.netlify.com/). For form submissions, I use [Netlify's form handling](https://docs.netlify.com/forms/setup/). For styling, I use CSS Modules and SCSS.
The source code is available on my [GitHub](https://github.com/rsapkf/rsapkf.xyz).

I followed the official [Gatsby tutorial](https://www.gatsbyjs.org/tutorial/) to learn Gatsby. Having previous knowledge of React and GraphQL makes it a lot easier.
...
If you have further questions about how I implemented a particular feature on this site, <Link to='/contact'>hit me up</Link>!
