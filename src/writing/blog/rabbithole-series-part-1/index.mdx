...
I found that the default look that `i3` comes with isn't very attractive. Not just it's look, but I had to do a number of additions and modifications to its config file to make things work properly.
