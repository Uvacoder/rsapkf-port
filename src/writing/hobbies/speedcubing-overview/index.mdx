...
I have compiled my favorite **_YouCubers_** and resources for algorithms, walkthroughs and tutorials on Rubik's Cube and other puzzles [here](https://links.rsapkf.xyz/docs/cubing-puzzles-and-magic).
